...
def draw_bbox(image, bboxes, classes=read_class_names(cfg.YOLO.CLASSES), show_label=True, fontScale=0.5):
    """
...
def postprocess_boxes(pred_bbox, org_img_shape, input_size, score_threshold, clip=True):
